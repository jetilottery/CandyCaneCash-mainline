define(require => {
    ...
    function setState(data) {
        ...
        // FIX - PEPPER-193
        // The coins animation for winning shows if setting "showResultScreen" as false.

        if (gameConfig.showResultScreen) {

            console.log("----------- SHOW COIN SHOWER!-------------------");

            _container.visible = true; // Toggle coin shower

            particleManager({
                mode: 1,
                level: findPrizeLevel()
            });
        }
    }
